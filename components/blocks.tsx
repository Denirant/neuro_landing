      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">We turn complexity into simplicity.</h2>
            <p className="text-xl text-gray-400">We simplify the complex, streamlining your workflows for effortless efficiency, allowing you to focus on what truly matters.</p>
          </div>
